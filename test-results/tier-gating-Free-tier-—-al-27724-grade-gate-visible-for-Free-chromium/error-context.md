...
- Name: tier-gating.spec.ts >> Free tier — all Plus+Pro features blocked >> Groups — Plus Feature upgrade gate visible for Free
- Location: tests\tier-gating.spec.ts:350:7
...
Locator: locator('text=Plus Feature').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Plus Feature').first()
...
- main:
  - text: 🔥
  - heading "Group Habits" [level=1]
  - paragraph: Track the same habit together with friends or family
  - paragraph: Create a group, invite your squad, and build a shared streak. Everyone tracks the same habit — miss a day and the group streak resets.
  - paragraph: Plus or Pro required
  - paragraph: Group Habits are available on Plus and Pro plans. Upgrade to create or join a group and hold each other accountable.
  - link "Upgrade to Plus →":
    - /url: /settings?tab=billing
  - text: 👥
  - paragraph: No group yet.
  - paragraph: Upgrade to Plus to create or join groups.
- text: Offline — showing cached habits
- alert
- dialog "Cookie consent":
  - paragraph: Cookies & Privacy
  - paragraph: We use cookies to keep you logged in and improve your experience. No tracking or ad cookies.
  - button "Accept"
  - link "Learn more":
    - /url: /privacy
  - button "Dismiss"
