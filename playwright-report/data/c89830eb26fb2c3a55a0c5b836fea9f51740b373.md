...
- Location: tests\tier-gating.spec.ts:206:7
...
Locator: locator('button:has-text("min focus")').first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("min focus")').first()
...
- navigation:
  ...
  - link "HabitAI Dashboard":
    - /url: /dashboard
    - text: habitAI
  - text: "1 45 XP · Next reward: Lv 5 🛡️"
  - button "AI Coaching"
...
- main:
  ...
  - button "Analyse →"
  - button "Dismiss"
  - paragraph: Sunday, July 12
  - heading "Good evening 👋" [level=1]
  - button "0d streak"
  - button "🌱 Lv 1 Beginner"
  ...
  - paragraph: Starting fresh · 45 XP earned. Your coach spots patterns across your habits and streaks to help you level up faster.
