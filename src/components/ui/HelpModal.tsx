  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div className="mobile-sheet-enter w-full sm:max-w-sm bg-[#0f0f1a] border border-violet-800/30 rounded-t-2xl sm:rounded-2xl shadow-2xl overflow-hidden" style={{ paddingBottom: "env(safe-area-inset-bottom, 0px)" }}>
            {/* Header */}
