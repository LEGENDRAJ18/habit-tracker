...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Click "Upgrade Plan" in the left sidebar or visit the Billing page in Account Settings. Plus is $7/month and unlocks unlimited habits, AI coaching, and streak protection.',
    icon: CreditCard,
  },
];
