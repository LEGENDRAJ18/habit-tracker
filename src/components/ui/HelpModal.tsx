...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Click "Upgrade Plan" in the left sidebar or visit the Billing page in Settings. Plus is $5.99/month and unlocks unlimited habits, AI coaching, and streak protection.',
    icon: CreditCard,
  },
];
