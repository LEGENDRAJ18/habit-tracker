...
export default function HabitDNAModal({ habits, logs, tier, totalXP, onClose, onUpgrade }: Props) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-start justify-center pt-16 p-4 overflow-y-auto bg-black/75 backdrop-blur-sm"
      onClick={(e) => e.target === e.currentTarget && onClose()}
    >
      <div
        className="w-full max-w-lg bg-[#0b0b18] border border-violet-700/20 rounded-3xl shadow-2xl overflow-hidden max-h-[88vh] flex flex-col"
        style={{
