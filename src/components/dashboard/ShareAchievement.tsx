        ...
        <div className="p-5">
          ...
          <div className="space-y-2.5">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full flex items-center justify-center gap-2.5 py-3 bg-[#1a1a2e] hover:bg-[#232340] border border-[#25D366]/30 hover:border-[#25D366]/60 text-[#25D366] font-semibold rounded-xl text-sm transition-all"
            >
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor" aria-hidden>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full flex items-center justify-center gap-2.5 py-3 bg-[#1a1a2e] hover:bg-[#232340] border border-[#1877F2]/30 hover:border-[#1877F2]/60 text-[#1877F2] font-semibold rounded-xl text-sm transition-all"
            >
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor" aria-hidden>
