...
const ROWS: ComparisonRow[] = [
  ...
  { label: "Habit Battles",          free: "no",        plus: "Unlimited",  pro: "Unlimited"  },
  { label: "Full Habit DNA",         free: "no",        plus: "yes",        pro: "yes"        },
  { label: "Commitment Contracts",   free: "no",        plus: "yes",        pro: "yes"        },
  { label: "Group habits",           free: "no",        plus: "yes",        pro: "yes"        },
  { label: "Weekly email report",    free: "no",        plus: "yes",        pro: "yes"        },
