...
export default function CommitmentModal({
  ...
  return (
    ...
    >
      <div className="mobile-sheet-enter w-full sm:max-w-sm bg-[#0d0d1a] border border-violet-700/30 rounded-t-3xl sm:rounded-3xl shadow-2xl shadow-violet-950/60 overflow-hidden" style={{ paddingBottom: "env(safe-area-inset-bottom, 0px)" }}>
        {/* Header */}
