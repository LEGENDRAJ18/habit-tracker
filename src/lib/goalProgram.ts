...
export const CATEGORY_PLACEHOLDERS: Record<GoalCategory, string> = {
  ...
  academic: "e.g. I want to significantly improve my math grade by the end of the semester. I currently struggle with algebra and rarely study outside of class.",
