      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        {xpLoading ? (
          ...
          <>
            {/* Level card */}
            <div
              className="flex items-center gap-5 bg-[#0f0f1a] border border-violet-900/25 rounded-2xl p-6 mb-8"
            ...
            >
              <div className={`w-20 h-20 rounded-2xl ring-4 flex items-center justify-center flex-shrink-0 ${ringCls}`}
                   style={isGold ? { boxShadow: "0 0 20px rgba(251,191,36,0.4)" } : undefined}>
